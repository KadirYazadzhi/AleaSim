...
public interface IRtpEngine {
        ...
        Task<bool> ProcessWin(Guid gameId, Guid userId, decimal winAmount, decimal betAmount, IGameRepository repo);
        
        Task RecordBet(Guid gameId, Guid userId, decimal amount, IGameRepository repo);
