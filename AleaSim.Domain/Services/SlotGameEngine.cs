...
public class SlotGameEngine : BaseGameEngine {
    ...
    private static readonly SlotGameConfig _defaultConfig = new SlotGameConfig {
        ...
        Paytable = new Dictionary<int, decimal[]> {
            { 1, new[] { 4.0m, 15.0m, 60.0m } }, { 2, new[] { 4.0m, 15.0m, 60.0m } },
            { 3, new[] { 8.0m, 25.0m, 100.0m } }, { 4, new[] { 8.0m, 25.0m, 100.0m } },
            { 5, new[] { 18.0m, 50.0m, 180.0m } }, { 6, new[] { 18.0m, 50.0m, 180.0m } },
            { 7, new[] { 40.0m, 180.0m, 700.0m } }, { 8, new[] { 70.0m, 300.0m, 1500.0m } },
            { 9, new[] { 25.0m, 100.0m, 400.0m } }, { 12, new[] { 200.0m, 800.0m, 4000.0m } }
        }
    };
