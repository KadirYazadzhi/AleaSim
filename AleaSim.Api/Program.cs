...
using (var scope = app.Services.CreateScope()) {
    ...
    if (!existingGames.Any(g => g.Type == "Slot")) 
        db.Games.Add(new AleaSim.Domain.Entities.Game { Id = Guid.Parse("00000000-0000-0000-0000-000000000001"), Name = "Slot Machine", Type = "Slot", Provider = "AleaSim Originals", MinBet = 1, MaxBet = 1000, TargetRTP = 0.95m, IsActive = true, PoolBalance = 1000000m });
    if (!existingGames.Any(g => g.Type == "Roulette"))
        db.Games.Add(new AleaSim.Domain.Entities.Game { Id = Guid.Parse("00000000-0000-0000-0000-000000000002"), Name = "European Roulette", Type = "Roulette", Provider = "AleaSim Originals", MinBet = 1, MaxBet = 100000, TargetRTP = 0.97m, IsActive = true, PoolBalance = 1000000m });
    if (!existingGames.Any(g => g.Type == "Blackjack"))
        db.Games.Add(new AleaSim.Domain.Entities.Game { Id = Guid.Parse("00000000-0000-0000-0000-000000000003"), Name = "Blackjack", Type = "Blackjack", Provider = "AleaSim Originals", MinBet = 5, MaxBet = 1000, TargetRTP = 0.99m, IsActive = true, PoolBalance = 1000000m });
    if (!existingGames.Any(g => g.Type == "Baccarat"))
        db.Games.Add(new AleaSim.Domain.Entities.Game { Id = Guid.Parse("00000000-0000-0000-0000-000000000004"), Name = "Baccarat Royale", Type = "Baccarat", Provider = "AleaSim Originals", MinBet = 1, MaxBet = 5000, TargetRTP = 0.989m, IsActive = true, PoolBalance = 1000000m });
    ...
    if (!existingGames.Any(g => g.Type == "fruitblast"))
        db.Games.Add(new AleaSim.Domain.Entities.Game { Id = Guid.Parse("00000000-0000-0000-0000-000000000005"), Name = "Fruit Blast (Nuclear)", Type = "fruitblast", Provider = "AleaSim Originals", MinBet = 1, MaxBet = 1000, TargetRTP = 0.968m, IsActive = true, PoolBalance = 1000000m });
