...
public class AleaSimDbContext : DbContext {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        modelBuilder.Entity<Game>().HasData(
            ...
            new Game { Id = Guid.Parse("44444444-4444-4444-4444-444444444444"), Name = "Fruit Blast", Type = "fruitblast", Provider = "AleaSim Originals", IsActive = true, TargetRTP = 0.960m },
