    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "EmergencyStop", "Master switch to pause all games", new DateTime(2026, 2, 18, 20, 20, 45, 222, DateTimeKind.Utc).AddTicks(343), "false" },
                    { "GlobalTargetRtp", "Target RTP percentage for the system", new DateTime(2026, 2, 18, 20, 20, 45, 222, DateTimeKind.Utc).AddTicks(340), "95.0" },
                    { "VolatilityMode", "Global volatility profile (Low, Standard, High)", new DateTime(2026, 2, 18, 20, 20, 45, 222, DateTimeKind.Utc).AddTicks(345), "Standard" }
                });
